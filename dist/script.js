...
var accordion = function accordion(triggerSelector, blokcSelector) {
...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      upload = document.querySelectorAll('[name="upload"]'); // checkInputNumberOrNo('input[name="user_phone"');/
...
var pictureSize = function pictureSize(imgElement) {
  var blocks = document.querySelectorAll(imgElement);
...
var sliders = function sliders(slides, diraction, prev, next) {
  var slideIndex = 1,
      paused = false;
